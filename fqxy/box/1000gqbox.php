...
$wwpsl=3000;                     //需要的到某个物品的数量    //这里是新增物品必改值
...
$wwpsl=15000;                     //需要的到某个物品的数量    //这里是新增物品必改值
$wwpfl=4;                     //需要的到某个物品的是分类   //
//---------------------------------------------------------//
include("./pz/ini_pz01.php");//调用ini缓存位置
$wpsy=2;//使用成功
...
$wwpsl=8888;                     //需要的到某个物品的数量    //这里是新增物品必改值
$wwpfl=6;                     //需要的到某个物品的是分类   //
//---------------------------------------------------------//
include("./pz/ini_pz01.php");//调用ini缓存位置
$wpsy=2;//使用成功
...
$wwpsl=18;                     //需要的到某个物品的数量    //这里是新增物品必改值
...
//---------------------------------------------------------//
$q2="wp".$wjid;                //数据库位置               //
$wwpmz="〖圣贤宝石包〗（30个）";//需要的到某个物品的名字    // 
$wwpid=794;                   //需要的到某个物品的id      //
...
//---------------------------------------------------------//
$q2="wp".$wjid;                //数据库位置               //
$wwpmz="〖圣贤宝石包〗（8个）";//需要的到某个物品的名字    // 
$wwpid=793;                   //需要的到某个物品的id      //
