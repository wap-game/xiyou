...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>摊贩</font></a>"."<br>";
}
if ($rid==479||$rid==480||$rid==481) {
...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>胆小的书生</font></a>"."<br>";
}
