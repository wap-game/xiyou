...
if ($rid==64||$rid==65||$rid==66||$rid==67||$rid==68||$rid==69||$rid==70||$rid==71||$rid==72||$rid==73) {
...
$clj[]=43;
$npc[]=$strr1;
if ($rid==64||$rid==65||$rid==66||$rid==67||$rid==68||$rid==69||$rid==70||$rid==71||$rid==72) {
 ///////////////////////////////////////插入图片 /////////////////////////////
if ($tpbl==1) {
$img='pic/ts/ts1.png';
...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>练习仙法</font></a>"."<br>";
}
