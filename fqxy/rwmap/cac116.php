...
if ($rid==296||$rid==297||$rid==298||$rid==299) {
...
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>钓鲤鱼～</font></a>"."<br>";
}
...
include("./rwmap/cac116_ts.php");//任务提示	
...
$clj[]=43;
$npc[]=$strr1;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>渔夫李定</font></a>"."<br>";
} else {
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
