...
$sql1 = "insert into $q2 (id,wjid,vip,wjmz,jcjg,cq,timex)  values('$maxidd','$wjid','$cqwjvip','$cqwjmz','$sl','2','$timex')";
...
echo "<font color=red>恭喜你！使用花费了".$ylxx."银两进行【右开拳】猜拳请等待结果！！</font></a>"."<br>";
...
echo "<font color=balck>请输入你想右开拳的价格（银两）：</font>"."<br>";
?>
...
<input  type="submit" name="submit"  value="右开拳" id="search1"><br>
</form>
<?php
