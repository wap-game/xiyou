...
if($bpdj>=8){
echo "<font color=red>【八级国家商城】</font>"."<br>";	
...
$clj[]=606;
$npc[]=427;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖1万西游声望卷轴〗</font></a>";
echo "<font color=black>|</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=27;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（200贡献+5亿银两）</font></a>"."<br>";
...
$clj[]=606;
$npc[]=454;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖双倍掉宝符〗</font></a>";
echo "<font color=black>|</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=28;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（1000贡献+10亿银两）</font></a>"."<br>";
...
$clj[]=606;
$npc[]=494;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖荣誉宝石包〗（2个）</font></a>";
echo "<font color=black>|</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=29;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（100贡献+2亿银两）</font></a>"."<br>";
...
echo "<font color=black>八国家商城未开启（升级国家后开启）</font>"."<br>";
} 
