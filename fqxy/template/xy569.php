...
echo "<font color=black>恭喜你！！获得〖财神币〗x".$csbyq."</font>"."<br>";

} else{
echo "<font color=black>对不起！！所需要〖金豆〗不足！！</font>"."<br>";
...
echo "<font color=black>对不起~~你的财神币非法</font>"."<br>";
}	


} else{	
echo "<font color=black>对不起~~你的财神币不足</font>"."<br>";
}	
