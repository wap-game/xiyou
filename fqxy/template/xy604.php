...
if($bpdj>=10){
echo "<font color=red>【十级国家商城】</font>"."<br>";	
...
$clj[]=606;
$npc[]=626;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖5亿修炼经验丹〗</font></a>";
echo "<font color=black>|</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=605;
$npc[]=33;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（3000贡献+3亿银两）</font></a>"."<br>";
...
$clj[]=606;
$npc[]=627;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>〖10亿修炼经验丹〗</font></a>";
echo "<font color=black>|</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=627;
$npc[]=34;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（6000贡献+6亿银两）</font></a>"."<br>";
...
$clj[]=627;
$npc[]=35;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（1000贡献+1亿银两）</font></a>"."<br>";
...
echo "<font color=black>十国家商城未开启（升级国家后开启）</font>"."<br>";
} 
