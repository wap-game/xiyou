...
echo "<br>";
echo "<font color=black>黄金贵族|</font>";	
...
$hdcs=($iniFile->getItem('活动次数','62'));

if($hdcs >=1){
echo "<font color=red>剩余:".$hdcs."次（每天/次）</font>"."<br>";
echo "<br>";
echo "<font color=red>【黄金贵族】-</font>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=302;
...
echo "<font color=red>亲！【黄金贵族】已到期，或者未开通（在游戏左下角充值10元联系GM并告知开通月卡）</font><br>";

}

echo "<font color=black>介绍：玩家开通【黄金贵族】后每日领取〖金豆〗x2，〖黄金贵族宝箱〗x1</font><br>";
echo "<font color=black>【黄金贵族】10元/30次（单购,不计算vip积分）</font><br>";
echo "<font color=black>〖黄金贵族宝箱〗（随机必得三四五级石头x2）</font><br>";
