...
if($bpdj>=5){
echo "<font color=red>【五级国家商城】</font>"."<br>";	
...
$clj[]=605;
$npc[]=18;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（200贡献+4亿银两）</font></a>"."<br>";
...
$clj[]=605;
$npc[]=19;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（500贡献+10亿银两）</font></a>"."<br>";
...
echo "<font color=black>五国家商城未开启（升级国家后开启）</font>"."<br>";
} 
