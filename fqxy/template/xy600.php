...
if($bpdj>=6){
echo "<font color=red>【六级国家商城】</font>"."<br>";	
...
$clj[]=605;
$npc[]=22;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（1000贡献+50亿银两）</font></a>"."<br>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=606;
...
echo "<font color=black>六国家商城未开启（升级国家后开启）</font>"."<br>";
} 
