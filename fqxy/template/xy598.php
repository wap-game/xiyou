...
if($bpdj>=4){
echo "<font color=red>【四级国家商城】</font>"."<br>";	
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
$clj[]=606;
...
$clj[]=605;
$npc[]=15;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>兑换（150贡献+2亿银两）</font></a>"."<br>";
...
echo "<font color=black>四国家商城未开启（升级国家后开启）</font>"."<br>";
} 
