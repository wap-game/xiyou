...
//修炼等级提升
include("./ini/xl_ini.php");
$rwxldj=($iniFile->getItem('修炼等级','3'));
if($rwxldj==0){
$rwxldj=$rwxldj+2;
} else{	
$rwxldj=$rwxldj+1;
} 
$iniFile->updItem('修炼等级', ['3' => $rwxldj]);
$q2="xl".$wjid;  
$strsql = "update $q2 set xldj=$rwxldj where xlid=3";
$result = @mysql_query($strsql);
//修炼等级提升
//更新缓存数据
$inina="ztt.ini";
...
echo "<font color=red>恭喜你！！【人物修炼（魔）】成功，实力大幅度提升</font>"."<br>";
//数字转汉字
$yl=$fbb1;
include("./pz/ylts.php");
$fbb1=$ylxx;
...
echo "<font color=red>对不起！！【人物修炼（魔）】失败！！</font>"."<br>";
