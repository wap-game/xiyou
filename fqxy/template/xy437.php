...
echo "<font color=black>【金豆奖池】</font><br>";
echo "<font color=black>奖池：〖金豆〗x".$hdjc."</font><br>";
...
echo "<font color=black>第1名:〖金豆〗x".$fc01."</font><br>";
echo "<font color=black>第2名:〖金豆〗x".$fc02."</font><br>";
echo "<font color=black>第3名:〖金豆〗x".$fc03."</font><br>";
echo "<font color=black>第4名:〖金豆〗x".$fc04."</font><br>";
echo "<font color=black>第5名:〖金豆〗x".$fc05."</font><br>";
echo "<font color=black>第6名:〖金豆〗x".$fc06."</font><br>";
echo "<font color=black>第7名:〖金豆〗x".$fc07."</font><br>";
echo "<font color=black>第8名:〖金豆〗x".$fc08."</font><br>";
echo "<font color=black>第9名:〖金豆〗x".$fc09."</font><br>";
echo "<font color=black>第10名:〖金豆〗x".$fc10."</font><br>";
...
echo "<font color=black>截止时间：".$endtime."晚0点</font><br>";
echo "<br>";
//cmd及超链接值
$cmid=$cmid+1;
$cdid[]=$cmid;
