...
$ik=0;
$hm=count($phbzz2,0); 
echo "<font color=black>【疯狂摇点(黄金场)排名前10名玩家】(银两奖池)</font></a>"."<br>";
...
$clj[]=403;
$npc[]=0;
echo "<a href='xy.php?uid=$wjid&&cmd=$cmid&&sid=$a1'><font color=blue>返回娱乐</font></a>"."<br>";
