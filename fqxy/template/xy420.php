...
echo "<font color=black>至尊皇族</font>"."<br>";	
include("./ini/hd_ini.php");
$hdcs=($iniFile->getItem('活动次数','65'));
...
echo "<font color=red>亲！【至尊皇族】已到期，或者未开通（在游戏左下角充值100元联系GM并告知开通月卡）</font><br>";

}

echo "<br>";

echo "<font color=black>介绍：玩家开通【至尊皇族】后每日领取〖金豆〗x30，〖至尊皇族宝箱〗x1</font><br>";
echo "<font color=black>【至尊皇族】100元/30次（单购,不计算vip积分）</font><br>";
echo "<font color=black>〖至尊皇族宝箱〗（随机必得三四五级石头x30，随机必得各类区域门派声望卷x3，随机银两1000万-1亿）</font><br>";
