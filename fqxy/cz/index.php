...
<div class="cz_amt">	
<input name="Button1" type="submit"class="amtd" value="100元" onclick="document.form1.action='pay.php?cny=100&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button2" type="submit"class="amtd" value="200元" onclick="document.form1.action='pay.php?cny=200&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button3" type="submit"class="amtd" value="50元" onclick="document.form1.action='pay.php?cny=50&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button4" type="submit"class="amtd" value="10元" onclick="document.form1.action='pay.php?cny=10&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button5" type="submit"class="amtd" value="500元" onclick="document.form1.action='pay.php?cny=500&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button6" type="submit"class="amtd" value="1000元" onclick="document.form1.action='pay.php?cny=1000&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button7" type="submit"class="amtd" value="2000元" onclick="document.form1.action='pay.php?cny=2000&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
<input name="Button8" type="submit"class="amtd" value="20元" onclick="document.form1.action='pay.php?cny=20&&uid=<?echo $wjid;?>&&sid=<?echo $sid;?>'">
