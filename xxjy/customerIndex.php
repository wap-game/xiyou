...
$(function(){
	...
	if(s == 0)
	head(4,home,friend,family,bbs,msgbox,game,spShare,customer,about);
/*     if(s == 0){
...
<div class="bg_top ">
    <div class="title">
        <span class="font_lx">小轩社区客服</span>
    </div>
	...
	<div class="play ">
        <div class="friend_list">
                ...
                <li>
                    ...
                    <div class="right friend_right">
                        <div class="left friend_name font_l">
							...
							<p class="overflow_p">客服QQ：137154720</p>
							
                            <p class="overflow_p">微信：ylgv520</p>
                        </div>
                    </div>
                </li>
			...
			<p class="font_l">请看清上述客服qq与微信，防止上当受骗</p>
