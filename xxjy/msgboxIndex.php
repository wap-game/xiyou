...
$(function(){
	...
	if(s == 0)
	head(7,home,friend,family,bbs,msgbox,game,spShare,customer,about);
/*     if(s == 0){
...
<div class="bg_top ">
	...
	<div class="play ">
      ...
      <p class="font_l">&nbsp</p>
			...
			<p class="font_l">本网站成立于2018年6月1日，自成立以来，一切以用户价值为依归的经营理念，始终处于稳健、高速发展的状态，</p>
      <p class="font_l">&nbsp</p>
	      <p class="font_l">&nbsp</p>
